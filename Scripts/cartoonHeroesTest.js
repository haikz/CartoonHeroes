...
cartoonHeroesTest.prototype = {
    ...
    showScreenThree: function () {
        ...
        _test = this;
        setTimeout(function () { _test.StartNewTestCase() }, this.options.timing.screenThree);
    },
    ...
    StartNewTestCase: function () {
        ...
        if (this.crrntTestCaseNo < this.testCases.length) {
            setTimeout(function () { _test.showScreenOne() }, 300); // delay peep lenght
        }
        else {
            _test.showResultScreen();
        }
    }
}
